...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/berkanakman/Documents/Berkan Projeler/e-ticaret/public/storage' => 'string',
...
'filesystems.links./Users/berkanakman/Documents/Berkan Projeler/e-ticaret/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'permissions.edit','permissions.update','permissions.destroy','admin.home',
'admin.login','admin.login.submit','admin.logout','admin.dashboard','admin.categories.index',
'admin.categories.create','admin.categories.store','admin.categories.edit','admin.categories.update','admin.categories.destroy',
'admin.categories.show','admin.categories.reorder','admin.categories.children.reorder','admin.products.index','admin.products.create',
'admin.products.store','admin.products.show','admin.products.edit','admin.products.update','admin.products.destroy',
'admin.attributes.index','admin.attributes.create','admin.attributes.store','admin.attributes.show','admin.attributes.edit',
'admin.attributes.update','admin.attributes.destroy','admin.attributes.options.ajax','admin.attributes.options.reorder','admin.',
'admin.products.variants.manual','admin.products.variants.generate','admin.uploads.quill-image','admin.orders.index','admin.orders.create',
'admin.orders.store','admin.orders.show','admin.orders.edit','admin.orders.update','admin.orders.destroy',
'admin.admins.index','admin.admins.create','admin.admins.store','admin.admins.show','admin.admins.edit',
...
'admin.layouts._navbar','admin.layouts._sidebar','admin.layouts.app','admin.permissions.create','admin.permissions.edit',
'admin.permissions.index','admin.products._attributes','admin.products._form','admin.products._manual_variant_modal','admin.products._variants',
'admin.products.create','admin.products.edit','admin.products.index','admin.roles.create','admin.roles.edit',
'admin.roles.index','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
